...
assertContains("styles.css", stylesCss, "caret-color: transparent;", "the oversized native line-box caret must remain hidden");
assertContains("styles.css", stylesCss, ".pdf-native-annotator-host .pdf-native-annotator-inline-text-caret-mirror {\n\tdisplay: block;", "the compact caret mirror must remain visible");
assertContains("styles.css", stylesCss, "height: 1em;", "the mirrored caret must match the full text height");
