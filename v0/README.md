> Archived v0 snapshot (0.12.9 working copy). Use [v2](../v2/) for the maintained plugin. Deployment tooling was hardened to copy only plugin files; the plugin implementation is preserved.
