...
const paperTemplatesTs = read("src/notebook/paperTemplates.ts");
...
assertContains("src/notebook/paperTemplates.ts", paperTemplatesTs, "const RULED_SPACING_MM = 8;", "ruled paper must use comfortable wide-ruled spacing");
assertContains("styles.css", stylesCss, "repeating-linear-gradient(", "live ruled pages must keep a genuinely blank header above the first line");
assertNotContains("src/notebook/paperTemplates.ts", paperTemplatesTs, "PAPER_TEMPLATE_MARGIN_COLOR", "ruled paper must not retain the red margin color");
assertNotContains("src/notebook/paperTemplates.ts", paperTemplatesTs, "ruledMarginX", "ruled paper metrics must not retain an unused left margin");
assertNotContains("src/notebook/templateCanvas.ts", templateCanvasTs, "PAPER_TEMPLATE_MARGIN_COLOR", "exported ruled pages must not draw a red margin line");
assertNotContains("styles.css", stylesCss, "--annotator-template-margin-color", "live ruled pages must not draw a red margin line");
