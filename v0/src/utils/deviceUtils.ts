...
/**
 * Detect Apple touch platforms where Pencil may be exposed as a touch-like
 * pointer by WebKit. Android stylus input should arrive as pointerType="pen".
 */
export function isAppleTouchPlatform(): boolean {
