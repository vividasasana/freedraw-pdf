> Archived v1 snapshot (0.12.10 release). Use [v2](../v2/) for the maintained plugin. Deployment tooling was hardened to copy only plugin files; the plugin implementation is preserved.
