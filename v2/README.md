...
This is the separate v2 implementation copied from v1. See [V2 changes and testing](V2-CHANGES.md) for the interaction improvements, shortcuts, and local test-vault instructions.
...
- **Flexible erasing:** object and segment eraser modes remove contacted annotations while preserving untouched strokes and using smooth rounded caps at segment cuts.
...
If Freedraw PDF appears in the community directory, install it there. Otherwise use the GitHub release installation above.
